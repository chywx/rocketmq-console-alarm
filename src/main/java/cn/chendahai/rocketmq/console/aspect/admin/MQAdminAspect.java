 ...
 */
package cn.chendahai.rocketmq.console.aspect.admin;

import java.lang.reflect.Method;

import cn.chendahai.rocketmq.console.aspect.admin.annotation.MultiMQAdminCmdMethod;
import cn.chendahai.rocketmq.console.service.client.MQAdminInstance;
...
public class MQAdminAspect {
    ...
    @Pointcut("execution(* cn.chendahai.rocketmq.console.service.client.MQAdminExtImpl..*(..))")
    public void mQAdminMethodPointCut() {

    }

    @Pointcut("@annotation(cn.chendahai.rocketmq.console.aspect.admin.annotation.MultiMQAdminCmdMethod)")
